(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__9806a4._.js", {
...
function ChatHistory() {
    ...
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"])(); // Tambahkan router untuk navigasi
    ...
    const fetchChats = async ()=>{
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get("http://localhost:3000/api/history", {
                headers: {
    ...
    const handleCreateOrUpdate = async ()=>{
        try {
            ...
            if (editingChat) {
                // Update chat
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].put(`http://localhost:3000/api/history?id=${editingChat._id}`, {
                    title
                }, {
                    headers: {
                        Authorization: `Bearer ${token}`
                ...
                // Create chat
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post("http://localhost:3000/api/history", {
                    title
                }, {
                    headers: {
                        Authorization: `Bearer ${token}`
    ...
    const handleDelete = async (id)=>{
        try {
            const token = localStorage.getItem("token");
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].delete(`http://localhost:3000/api/history?id=${id}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        className: "text-white fixed bottom-20 right-5",
                        onClick: ()=>openModal(),
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__9806a4._.js.map