...
"[project]/src/pages/auth/login/index.jsx [ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const Login = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        if ("undefined" !== "undefined" && localStorage.getItem("token")) {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].post("http://localhost:5000/api/auth/login", {
                email,
                password
            });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d03c45._.js.map