...
import { requestToVision } from "../../services/models/vision-llama-3.2-90b";
...
const Vision = () => {
  ...
  const [selectedOption, setSelectedOption] = useState("vision-llama-3.2-90b");
  ...
  const handleSend = async () => {
    ...
    try {
      const aiResponse = await requestToVision(input);
