...
import { requestToLlama } from "../../services/models/llama3-70b-8192";
...
const Llama = () => {
  ...
  const [selectedOption, setSelectedOption] = useState("llama3-70b-8192");
  ...
  const handleSend = async () => {
    ...
    try {
      const aiResponse = await requestToLlama(input);
