...
import { requestToJawirAI } from "../../services/models/jawiraiv1-6-3";
...
const JawirAI = () => {
  ...
  const [selectedOption, setSelectedOption] = useState("jawiraiv1-6-3");
  ...
  const handleSend = async () => {
    ...
    try {
      const aiResponse = await requestToJawirAI(input);
