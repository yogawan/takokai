...
import { requestToGemma } from "../../services/models/gemma2-9b-it";
...
const Gemma = () => {
  ...
  const [selectedOption, setSelectedOption] = useState("gemma2-9b-it");
  ...
  const handleSend = async () => {
    ...
    try {
      const aiResponse = await requestToGemma(input);
