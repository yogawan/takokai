...
import { requestToSpecDec } from "../../services/models/specdec-llama-3.3-70b";
...
const SpecDec = () => {
  ...
  const [selectedOption, setSelectedOption] = useState("specdec-llama-3.3-70b");
  ...
  const handleSend = async () => {
    ...
    try {
      const aiResponse = await requestToSpecDec(input);
